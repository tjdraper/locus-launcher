    ...
    var body: some View {
        LabeledContent {
            ...
            Text(workflow.location.isInApplicationsFolder
                ? "Locus Launcher can update itself and open at login."
                : "Locus Launcher needs to be in Applications to update itself and open at login. Moving it relaunches the app.")
        }
    }
}
