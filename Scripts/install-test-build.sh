...
# /Applications, and opens it. Unlike a Debug build, it can use the Accessibility access already
# granted to the released app, because it is signed the same way.
#
